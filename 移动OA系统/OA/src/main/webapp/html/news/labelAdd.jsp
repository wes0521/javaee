...
<head>
    ...
    <script>
        function tianjia() {
            alert("添加成功！")
            //window.self.location.href = "${pageContext.request.contextPath}/newlabel/insert.do";
        }
    </script>
</head>
...
<center>
    ...
    <form name="form1" method="post" action="${pageContext.request.contextPath}/newlabel/insert.do">
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
            ...
            <tr>
                ...
                <td width="86%" class="td_02">
                    <input name="label_name" type="text" class="input" style="width:99% ">
                </td>
            </tr>
            <tr>
                ...
                <td class="td_02">
                    <select name="parentLabel_name" class="input" style="width:99% ">
                        <option name="parentLabel_name" value="null" selected>--请选择--</option>
