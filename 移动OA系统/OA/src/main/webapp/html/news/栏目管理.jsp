...
<center>
    ...
    <form name="form1" method="post" action="">
            ...
            <tr>
                ...
                <td width="86%" class="td_02">
                    <select name="select" class="input" style="width:99% ">
                        ...
                        <option value="2" selected>体育新闻</option>
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
            ...
            <tr>
                <td colspan="5" align="right" class="td07"><img src="../../images/1.gif" width="4" height="5" align="absmiddle"> 首页　 <img src="../../images/2.gif" width="3" height="5" align="absmiddle"> 上一页　 <img src="../../images/2-2.gif" width="3" height="5" align="absmiddle"> <a href="${pageContext.request.contextPath}/newlabel/findAll.do?pagenum="+${page.pageNum+1} >下一页</a>　 <img src="../../images/3.gif" width="4" height="5" align="absmiddle"> 末页　　共 ${page.totalPages} 页 ${page.totalRows} 条记录</td>
            </tr>
            <tr>
