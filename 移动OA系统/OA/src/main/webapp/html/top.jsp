...
<head>
    ...
    <script language="javascript">
        function exitsys()
        {
            ...
            if(str==true)
            {
                parent.location.href="/login/clientLoginOut.do";
            }
        }
    </script>
</head>
...
<map name="Map">
    <area shape="rect" coords="20,6,55,55" href="main.jsp" target="mainFrame">
</map>
<map name="Map2">
    <area shape="rect" coords="8,6,60,54" href="${pageContext.request.contextPath}/login/clientLoginOut.do" target="_parent">
</map>
</body>
</html>
