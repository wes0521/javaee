...
<%@ taglib uri="http://wes.pager-tags" prefix="wes"%>
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="empform" method="post" id="empform" action="${pageContext.request.contextPath}/employee/findEmployee">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	职位：
					    ...
					    <td class="font3">
					    	性别：
					    		<select name="sex" style="width:143px;">
					    			...
					    			<option value="1" <c:if test="1 == ${employee.sex}">selected</c:if>>男</option>
					    			<option value="2" <c:if test="2 == ${employee.sex}">selected</c:if>>女</option>
					    		</select>
				...
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.id}"></td>
					 <td>${employee.name }</td>
					  ...
					  <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/employee/findEmployeeById?id=${employee.id}&pageIndex=${pageModel.pageIndex}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <wes:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${pageContext.request.contextPath}/employee/findEmployee?pageIndex={0}&dept_id=${employee.dept.id}&name=${employee.name}&sex=${employee.sex}&job_id=${employee.job.id}&phone=${employee.phone}&card_id=${employee.card_id}"/>
	  </td></tr>
	</table>
