...
//					!/^\d{4}-\d{2}-\d{2}$/.test($.trim(birthday.val()))
			...
			$.post("${pageContext.request.contextPath}/employee/modifyEmployee",
			$("#employeeForm").serialize(),
			function (data) {
				if (data == "OK"){
					alert("员工信息修改成功！");
					window.location.href = "${pageContext.request.contextPath}/employee/findEmployee?pageIndex=${pageIndex}";
				}
				else{
					alert("员工信息修改失败！");
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr>
				<td class="font3 fftd">
					...
					name="birthday" id="birthday" value="<f:formatDate value="${employee.birthday}"
								type="date" pattern="yyyy-MM-dd"/>" size="40"/>&nbsp;&nbsp;
			...
			<tr><td align="left" class="fftd"><input type="button" value="修改" onclick="modifyEmployee()">&nbsp;&nbsp;<input type="reset" value="取消 "></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
