...
<html>
	...
	<script type="text/javascript">
		function addDept() {
			...
			$.post("${pageContext.request.contextPath}/dept/addDept",
				$("#deptForm").serialize(),
				function (data) {
					if (data != "FAIL"){
						alert("添加部门成功！");
						window.location.href = "${pageContext.request.contextPath}/dept/findDept?pageIndex="+data;
					}
					else{
						alert("添加部门失败！");
    ...
    <td>
    	 <form action="${pageContext.request.contextPath}/dept/addDept" id="deptForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" value="添加 " onclick="addDept()">&nbsp;&nbsp;<input type="reset" value="取消 "></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
