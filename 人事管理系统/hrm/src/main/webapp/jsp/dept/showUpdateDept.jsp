...
<html>
	...
	<script type="text/javascript">
		function modifyDept() {
				...
				$.post("${pageContext.request.contextPath}/dept/modifyDept",
						$("#deptForm").serialize(),
						function (data) {
							if (data == "OK"){
								alert("部门修改成功！");
								window.location.href = "${pageContext.request.contextPath}/dept/findDept?pageIndex=${pageIndex}";
							}
							else{
								alert("部门修改失败！");
    ...
    <td>
    	 <form action="" id="deptForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" value="修改" onclick="modifyDept()">&nbsp;&nbsp;<input type="reset" value="取消 "></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
