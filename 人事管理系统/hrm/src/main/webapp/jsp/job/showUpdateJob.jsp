...
<html>
	...
	<script type="text/javascript">
		function modifyJob() {
			...
			$.ajax({
				type:'post',
				url:'${pageContext.request.contextPath}/job/modifyJob',
				data:$("#jobForm").serialize(),
				success:function (data) {
					if (data == "OK"){
						alert("职位修改成功！");
						window.location.href = "${pageContext.request.contextPath}/job/findJob?pageIndex=${pageIndex}";
					}
					else{
						alert("职位修改失败！");
    ...
    <td>
    	 <form action="" id="jobForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" value="修改 " onclick="modifyJob()">&nbsp;&nbsp;<input type="reset" value="取消 "></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
