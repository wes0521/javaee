			...
			$.ajax({
				...
				success:function (data) {
					if (data == "FAIL"){
						...
						alert("职位添加成功！");
						window.location.href = "${pageContext.request.contextPath}/job/findJob?pageIndex="+data;
					}
				}
			});
	}
    ...
    <td>
    	 <form action="" id="jobForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" value="添加 " onclick="addJob()">&nbsp;&nbsp;<input type="reset" value="取消 "></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
