...
<script type="text/javascript" src="${pageContext.request.contextPath}/client/js/jquery-3.4.1.js"></script>
<script type="text/javascript">
	function findUsername() {
		$.post("${pageContext.request.contextPath}/client/user/findUsername?username="+$("#username").val(),
				function (data) {
					if (data == "EXIST"){
						alert("会员名已被占用，请使用其他会员名！");
						//当输入的会员名被占用时，清空输入框
						$("#username").val("");
					}
				});
					...
					<td style="padding: 30px">
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="color: #cc0000">${requestScope.check_error}</td>
							</tr>
							<tr>
