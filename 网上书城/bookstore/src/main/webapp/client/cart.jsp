                    ...
                    <tr>
                        <td>
                            ...
                            <table width="100%" border="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <img src="${pageContext.request.contextPath}/client/images/buy1.gif" width="635"
                                             height="38"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                            ...
                                            <table width="100%" border="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="20%">
                                                        ...
                                                        <input name="text" type="text" value="${entry.value}" readonly
                                                               style="width:40px;text-align:center"/>
                                                        <input type="button" value='+' style="width:20px"
                                                               onclick="changeProductNum('${entry.value+1}','${entry.key.pnum}','${entry.key.id}')">
                                                    </td>
                                                    <td width="10%">${entry.key.pnum>0?entry.key.pnum:0}</td>
                                        ...
                                        <div style="text-align:right; margin-top:10px">
                                            ...
                                            <a href="${pageContext.request.contextPath}/client/product/showIndex">
											...
											<c:forEach items="${cart}" var="entry" varStatus="vs">
												<table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="10%">${entry.key.price }</td>
														<c:choose>
															<c:when test="${entry.key.pnum < 1}">
																<td width="20%">
																	<p style="color: #cc0000">目前此商品无库存，请购买其他商品</p>
																</td>
