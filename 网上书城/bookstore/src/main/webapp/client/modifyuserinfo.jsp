...
<%@ taglib prefix="p" uri="http://wes.login-tags" %>
    ...
    <table width="100%" border="0" cellspacing="0">
        <tr>
            ...
            <td>
                ...
                <form action="${pageContext.request.contextPath}/client/user/modifyUser" method="post">
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="2" class="upline">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="password" class="textinput" name="password" id="password"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">&nbsp;&nbsp;
                                            <input type="radio" name="gender"
                                                   value="男" ${login_user.gender=='男'?'checked':'' }/> 男
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" name="gender"
                                                   value="女"  ${login_user.gender=='女'?'checked':'' }/> 女
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align:right">联系方式：</td>
                                        <td colspan="2">
                                            <input name="telephone" type="text" value="${login_user.telephone}"
                                                   class="textinput"/>
                                        </td>
                                    </tr>
                                    <tr>
