        ...
        <tr>
            <td>
                ...
                <table cellspacing="0" class="infocontent">
                    <tr>
                        <td><img src="${pageContext.request.contextPath }/client/ad/page_ad.jpg" width="900"
                                 height="84"/>
                            <table width="100%%" border="0" cellspacing="0">
                                <tr>
                                    <td width="30%">
                                        ...
                                        <c:choose>
                                            <c:when test="${p.pnum < 1}">
                                                <div>
                                                    <h3 style="color: #cc0000">目前此商品无库存，请购买其他商品</h3>
                                                </div>
                                            </c:when>
                                            <c:otherwise>
                                                <div style="text-align:center; margin-top:25px">
                                                    <a href="${pageContext.request.contextPath}/client/cart/addCart?id=${p.id}">
                                                    <%--<a href="#" onclick="checkpum('${p.id}','${p.pnum}');"></a>--%>
