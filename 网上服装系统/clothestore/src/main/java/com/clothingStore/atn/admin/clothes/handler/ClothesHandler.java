...
public class ClothesHandler {
    ...
    private String uploadImg(MultipartFile upload, HttpSession session) throws IOException {
        ...
        String path1 = "E:\\JavaEE\\Spring\\Spring_next\\clothestore\\src\\main\\webapp\\shopping\\html\\assets\\img";
    ...
    private void deleteImg(Integer id, HttpSession session) {
        ...
        File targetFile1=new File("E:\\JavaEE\\Spring\\Spring_next\\clothestore\\src\\main\\webapp\\shopping\\html\\assets\\"+target.getClothImg());
