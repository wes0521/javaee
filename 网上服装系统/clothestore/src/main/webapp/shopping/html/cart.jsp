...
<head>
    ...
    <script>
        ...
        function viewConsume(price) {
            if (price==null){
                alert("当前购物车为空！");
            }else if (confirm("查看订单")){
    ...
    <div class="container" id="columns">
        ...
        <%--<c:choose>
            <c:when test="${cart == null}">
                <span style="color: red;font-size: 18px;">当前购物车为空!</span>
            </c:when>
            <c:otherwise>--%>
         <div class="page-content page-order">
            <div class="order-detail-content">
                ...
                <div class="cart_navigation">
                    <a class="next-btn" href="javascript:void(0)" onclick="viewConsume(${totalPrice})">确认订单
                    </a>
                </div>
            </div>
        </div>
