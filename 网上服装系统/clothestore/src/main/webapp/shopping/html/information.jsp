                    ...
                    <div class="box-authentication" >
                        <form action="${pageContext.request.contextPath}/shop/user/modifyPassWord" method="post" id="userUpdateForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" onkeyup="checkPassword()" class="form-control" name="userPassword" id="userPassword" value="${sessionScope.login_user.userPassword}" placeholder="请输入密码">
                                <span id="userPasswordMsg" style="color: red;"></span>
                            </div>
                            <div class="form-group">
                                <label for="userPassword1">重复密码</label>
                                <input type="text" onkeyup="checkPassword1()" class="form-control" name="userPassword1" id="userPassword1" value="${sessionScope.login_user.userPassword}" placeholder="请再次输入密码">
