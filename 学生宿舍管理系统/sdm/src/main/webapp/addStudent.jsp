    ...
    <div class="body-content">
        <form method="post" class="form-x" action="${pageContext.request.contextPath}/student/addStudent.do">
            <div class="form-group">
                ...
                <div class="field">
                    <label style="line-height:33px;">
                        <input type="text" class="input w50" id="mpass" name="sno" size="50" placeholder="请输入学生学号" data-validate="required:请输入学生学号" />
                    </label>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="password" class="input w50" name="password" size="50" placeholder="请输入学生登录密码" data-validate="required:请输入学生登录密码" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <label style="line-height:33px;">
                        <input type="text" class="input w50"  name="sex" size="50" placeholder="请输入学生性别" data-validate="required:请输入学生性别" />
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <label style="line-height:33px;">
                        <input type="text" class="input w50" name="college" size="50" placeholder="请输入学生专业" data-validate="required:请输入学生手机号" />
                    </label>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <label style="line-height:33px;">
                        <input type="text" class="input w50"  name="phone" size="50" placeholder="请输入学生手机号" data-validate="required:请输入管理员姓名" />
                    </label>
                </div>
            </div>
            <div class="form-group">
